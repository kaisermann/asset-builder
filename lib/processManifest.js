...
module.exports = function (json) {
	...
	var required = ['config.fileTypes', 'dependencies'];
	...
	if (_.isPlainObject(json)) {
		...
		_.forOwn(json.dependencies, function (deps, depType) {
			_.forOwn(deps, function (dependency, depName) {
				if (!dependency.external) {
					json.dependencies[depType][depName].files = _.map(dependency.files, function (file) {
